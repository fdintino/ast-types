...
export type ExpressionKind = namedTypes.Identifier | namedTypes.FunctionExpression | namedTypes.ThisExpression | namedTypes.ArrayExpression | namedTypes.ObjectExpression | namedTypes.Literal | namedTypes.SequenceExpression | namedTypes.UnaryExpression | namedTypes.BinaryExpression | namedTypes.AssignmentExpression | namedTypes.MemberExpression | namedTypes.UpdateExpression | namedTypes.LogicalExpression | namedTypes.ConditionalExpression | namedTypes.NewExpression | namedTypes.CallExpression | namedTypes.ArrowFunctionExpression | namedTypes.YieldExpression | namedTypes.GeneratorExpression | namedTypes.ComprehensionExpression | namedTypes.ClassExpression | namedTypes.TaggedTemplateExpression | namedTypes.TemplateLiteral | namedTypes.AwaitExpression | namedTypes.OptionalMemberExpression | namedTypes.OptionalCallExpression | namedTypes.ImportExpression | namedTypes.JSXIdentifier | namedTypes.JSXExpressionContainer | namedTypes.JSXMemberExpression | namedTypes.JSXElement | namedTypes.JSXFragment | namedTypes.JSXText | namedTypes.JSXEmptyExpression | namedTypes.JSXSpreadChild | namedTypes.TypeCastExpression | namedTypes.BooleanLiteral | namedTypes.NumericLiteral | namedTypes.StringLiteral | namedTypes.DoExpression | namedTypes.Super | namedTypes.BindExpression | namedTypes.MetaProperty | namedTypes.ParenthesizedExpression | namedTypes.DirectiveLiteral | namedTypes.BigIntLiteral | namedTypes.NullLiteral | namedTypes.RegExpLiteral | namedTypes.PrivateName | namedTypes.Import | namedTypes.TSAsExpression | namedTypes.TSNonNullExpression | namedTypes.TSTypeParameter | namedTypes.TSTypeAssertion;
...
export type LiteralKind = namedTypes.Literal | namedTypes.JSXText | namedTypes.BooleanLiteral | namedTypes.NumericLiteral | namedTypes.StringLiteral | namedTypes.BigIntLiteral | namedTypes.NullLiteral | namedTypes.RegExpLiteral;
...
export type EnumBodyKind = namedTypes.EnumBooleanBody | namedTypes.EnumNumberBody | namedTypes.EnumStringBody | namedTypes.EnumSymbolBody;
...
export type EnumMemberKind = namedTypes.EnumBooleanMember | namedTypes.EnumNumberMember | namedTypes.EnumStringMember | namedTypes.EnumDefaultedMember;
